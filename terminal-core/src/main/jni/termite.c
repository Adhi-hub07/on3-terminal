...
Java_com_on3_terminal_core_TerminalJNI_createSubprocess(
        JNIEnv* env,
        jclass clazz,
        jstring cmd,
        jstring cwd,
...
Java_com_on3_terminal_core_TerminalJNI_setPtyWindowSize(
...
JNIEXPORT jint JNICALL
Java_com_on3_terminal_core_TerminalJNI_waitFor(
...
JNIEXPORT void JNICALL
Java_com_on3_terminal_core_TerminalJNI_close(
